...
class Shapes {
	...
	static Mesh unit_dot = meshCircle(0, 0, 0, 0, 360, 20, 1f);
			
	public static Mesh meshCircle(float x, float y, float z, double start_angle, double end_angle, int resolution, float length) {
	...
	public static void dot(int x, int y, int z, int radius) {
		...
		RenderQueue.queue(unit_dot, transform, color, white);
	}
