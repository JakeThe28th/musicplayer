...
public class Playlist {
	...
	public SimpleTexture glcover() {
		if (glcover == null) {
			if (cover == null) {
				glcover = new SimpleTexture(new byte[] { (byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF }, 1, 1);
				return glcover;
			}
			glcover = new SimpleTexture(cover);
		}
		return glcover;
	}
	...
	public void trysave() {
		try {
			...
			UI.showError("Failed to save playlist/or/album to disk");
			e.printStackTrace();
		}
	}
