...
public class Utility {
	...
	public static ArrayList<Object> loadClassesFromFolder(String path) throws IOException {
        ...
        for (File file : new File(path).listFiles()) {
        	...
        	FallbackGraphics.center_text(0, 0, "Initializing Extensions...");
    		FallbackGraphics.center_text(0, 30, "Reading source "+ file.toString() +"...");
        ...
        for (File file : new File(path).listFiles()) {
        	...
        	FallbackGraphics.center_text(0, 0, "Initializing Extensions...");
        	FallbackGraphics.center_text(0, 30, "Loading class "+ file.toString() +"...");
        	FallbackGraphics.end_text();
